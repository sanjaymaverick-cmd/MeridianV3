...
Name: **INFY**. Dedicated book: ₹50,000 cash, no open clips. Live disarmed.
...
9. **Size.** Fractional Kelly × confidence × ATR → 1 share, stop ≈ ₹33, risk ≈ ₹33 (0.07% of book).
10. **Safety.** Live disarmed. Session open. Drawdown 0. Paper allowed. Live blocked.
11. **OMS.** PaperBroker buys 1 INFY at 1,488. Cash 48,512. Review card written: “Auto decision review (not an order)”.
